    ...
    <main class="staff-grid">
      ...
      <section class="control-panel">
        <form id="windowForm" class="form-row">
          <label for="windowInput">Mi ventanilla</label>
        ...
        <div class="action-stack">
          <button id="nextButton" class="large-action" type="button">Siguiente número</button>
          <button id="recallButton" class="secondary-action button-reset" type="button">Volver a llamar</button>
        </div>
